...
| PW10 | Pendente | HM8 | **Integrações:** botão "Conectar" sem fluxo; Google Classroom exibe "Conectado ✓" estático sem ação de desconectar ou configurar. | Configurações \> Integrações | **2** | Simular fluxo OAuth mock ou desabilitar com label "Em breve"; toggle conectar/desconectar no protótipo. | Davi |
...
| :---- | :---- | :---- | :---- | :---- |
| Parte I (v2) | `/app` | 20 | **20** | 0 |
| Parte II (v3) | `/web` | 15 | **7** | 8 |
| **Total** | — | **35** | **27** | **8** |

**Corrigidos — Parte I:** P01, P02, P03, P04, P05, P06, P07, P08, P09, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20  
