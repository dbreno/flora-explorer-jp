...
export const alunosRelatorio = [
  ...
  { name: "Paulo S.", status: "fez", plantas: ["Ipê-amarelo", "Amendoeira"], xp: 45, data: "13/06" },
  { name: "Ana Beatriz", status: "fez", plantas: ["Mangueira", "Ipê-amarelo"], xp: 40, data: "13/06" },
  ...
  { name: "Tobias Freire", status: "fez", plantas: ["Pau-brasil", "Mangueira", "Ipê-amarelo"], xp: 55, data: "12/06" },
  { name: "Davi Teixeira", status: "fez", plantas: ["Cajueiro", "Ipê-amarelo"], xp: 40, data: "13/06" },
